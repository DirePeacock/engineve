...
from .utils import get_rando
from .combatactoriterator import CombatActorIterator
# from .enginecommands.receiver import Receiver
class GameStateManager():
    ...
    def instantiate(cls):
        instance = cls()
        instance.add_actor(Actor(name=get_rando(), team=1))
        instance.add_actor(Actor(name=get_rando(), team=2))
        return instance
