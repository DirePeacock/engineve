...
def load_archetypes():
    ...
    DATA = {}
    from ..rulebook import monsters

    for arch_name, arch_data in monsters.monsters.items():
        ARCHETYPES["MonsterArchetypes"][arch_name] = MonsterArchetype.load_from_json(
            arch_data
        )
    ...
    #         ARCHETYPES["MonsterArchetypes"][
    #             arch_name
    #         ] = MonsterArchetype.load_from_json(arch_data)
